            ...
            {readOnly ? (
                <div className="w-full mt-4 flex ">
                    ...
                    <input
                        ...
                        className={
                            name
                                ? 'block w-[62%]  pl-1 py-2  mt-2 ml-[-5px] text-gray-700 text-xs placeholder-gray-500 bg-gray-300 border rounded-md focus:border-blue-400 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300'
                                : 'block w-full  pl-1 py-2  mt-2 text-gray-700 placeholder-gray-500 bg-gray-300 border rounded-md focus:border-blue-400 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300'
                        }
                        name={name}
                        type={type}
