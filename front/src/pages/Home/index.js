...
const Home = () => {
  return (
    <div className='bg-orange-100'>
      <div className='w-full max-w-5xl p-2 lg:py-10 mx-auto'>
        <div className="flex flex-col justify-center items-center gap-10 w-full px-10 py-12 bg-white rounded-lg shadow-md">
